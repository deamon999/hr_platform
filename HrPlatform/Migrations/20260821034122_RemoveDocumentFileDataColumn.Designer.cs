...
namespace HrPlatform.Migrations
{
    ...
    [Migration("20260821034122_RemoveDocumentFileDataColumn")]
    partial class RemoveDocumentFileDataColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrPlatform.Data.Entities.Lead", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("CompanyId", "Email"), false);

                    b.HasIndex("CompanyId", "Phone")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("CompanyId", "Phone"), false);

                    b.ToTable("Leads");
                });

            modelBuilder.Entity("HrPlatform.Data.Entities.LeadNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HrPlatform.Data.Models.DriverProfile", b =>
                {
                    ...
                    b.Property<int>("CarHaulerExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DryVanExperience")
                        .HasColumnType("integer");

                    b.Property<int>("DumpExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("FlatbedExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LowboyExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PneumaticExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ReeferExperience")
                        .HasColumnType("integer");

                    b.Property<int>("RgnExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("StepDeckExperience")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TankerExperience")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HrPlatform.Data.Entities.Lead", b =>
                {
                    ...
                    b.HasOne("HrPlatform.Data.Models.ApplicationUser", "ConvertedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HrPlatform.Data.Entities.LeadNote", b =>
                {
                    b.HasOne("HrPlatform.Data.Models.ApplicationUser", "AuthorUser")
                        .WithMany()
                        .HasForeignKey("AuthorUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HrPlatform.Data.Entities.Lead", "Lead")
                        .WithMany("Notes")
